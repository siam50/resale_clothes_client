...
const Banner = () => {
    return (
        <div className="hero h-72 my-6 lg:my-8" style={{ backgroundImage: `url("http://st.depositphotos.com/1003633/2284/i/450/depositphotos_22848360-Fashion-clothes-hang-on-a-hanger.jpg")` }}>
